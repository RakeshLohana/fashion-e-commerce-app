                  ...
                  onPressed: () {
                     ...
                     setState(() {
                      ...
                      const Align(
                        ...
                        child: Text('Forgot Passwod?',style: TextStyle(fontSize:17,decoration:TextDecoration.underline, color: Colors.white))),
                        SizedBox(height: 20,),
                      InkWell(
                        onTap: (){
                          setState(() {
                          ...
                          _auth.signInWithEmailAndPassword(
                            ...
                            loading=false;
                                ...
                                Utils().snackBar('An Error Occured While Signing In',Colors.red,context);
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                           ...
                           child: Center(child: loading ? CircularProgressIndicator(strokeWidth:3,color: Colors.white,):Text('Sign In',style: TextStyle(color: Colors.white,fontSize: 23),)),
                        ),
                      ),
                      SizedBox(height: 20,),
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          GestureDetector(
                            ...
                            child: Text('Sign Up',style: TextStyle(fontWeight:FontWeight.bold,color:primaryColor,fontSize: 23),))
                        ],),
                      )
