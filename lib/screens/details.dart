...
import 'package:fashion_e_commerce_app/widget/add_to_cart.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<ProviderClass>(builder: (context,value,child){
      ...
      actions: [
         IconButton(
                  icon: Icon(
                    value.isFavorite(current.id)
                        ? Icons.favorite
                        : Icons.favorite_border,
                    color:
                        value.isFavorite(current.id) ? primaryColor : null,
                  ),
                  onPressed: () {
                    value.toggleFavorite(current.id);
                    print(value.favoriteItems);
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          image: DecorationImage(
                              image: AssetImage(current.imageUrl),alignment: Alignment.topCenter,
                              fit: BoxFit.cover),
                        ),
                      ),
                    ),
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                    color: value.selectedColor == index
                                        ? primaryColor
                                        : Colors.transparent,
                                    width: value.selectedColor == index ? 2 : 1),
                                borderRadius: BorderRadius.circular(15),
                              ),
                              duration: const Duration(milliseconds: 200),
                            ),
